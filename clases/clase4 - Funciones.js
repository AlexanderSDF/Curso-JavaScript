...
function mostrarNombre(nombre) {
	...
	console.log(
		`Hola ${nombre} bienvenido a Coder House, estamos encantados de tenerte con nosotros`
	);
}
...
function pedirCantNotas(nombreIngresado) {
	let notasIngresadas = parseInt(
		prompt(`Ingrese la cantidad de notas correspondientes a ${nombreIngresado}`)
	);
