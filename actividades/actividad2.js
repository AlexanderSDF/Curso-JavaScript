...
if (promedioNota >= 7) {
	alert(
		alumno +
			" su promedio general de calificaciones es " +
			promedioNota +
			"." +
			" Felicitaciones usted promociono la materia."
	);
	...
	alert(
		alumno +
			...
			promedioNota +
			"." +
			" Felicitaciones usted aprobó la materia, cursara el Final tipo 'A' del modulo 4, 5, 6 la Fecha 15/11/22."
	);
} else {
	alert(
		alumno +
			...
			promedioNota +
			"." +
			" Usted desaprobó la materia, deberá cursar el Final tipo 'B' del modulo 1, 2, 3, 4, 5 y 6 la Fecha 15/11/22."
	);
}
...
if (
	...
	colorFavorito.toLowerCase() == "amarillo" ||
	colorFavorito.toLowerCase() == "azul"
) {
	alert("El color " + colorFavorito + " es un color primario.");
} else if (
	colorFavorito.toLowerCase() == "violeta" ||
	colorFavorito.toLowerCase() == "verde" ||
	colorFavorito.toLowerCase() == "naranja"
) {
